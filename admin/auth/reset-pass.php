...
if (isset($_POST['updatepassbtn']) && $_POST['updatepassbtn']) {
    ...
    if ($newpass != $renewpass) {
        ...
        user_change_pass_by_email($_SESSION['emailreset'], $hashedPass);
...
<body>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <div class="ms-auto position-relative">
                                                    ...
                                                    <input type="password" name="newpass" class="form-control radius-30 ps-5" id="inputNewPassword" placeholder="Nhập mật khẩu mới">
                                                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="ms-auto position-relative">
                                                    ...
                                                    <input type="password" name="renewpass" class="form-control radius-30 ps-5" id="inputConfirmPassword" placeholder="Xác nhận mật khẩu">
                                                </div>
                                                <p class="error-message-reset"><?php echo isset($error['renewpass']) ? $error['renewpass'] : ''; ?></p>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid gap-3">
                                                    <input type="submit" name="updatepassbtn" class="btn btn-primary radius-30 bg-reset-pass" value="Thay đổi mật khẩu" />
                                                    <a href="./login.php" class="btn btn-light radius-30">Trở lại đăng nhập</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    <script src="../js/pages/validate.js"></script>
...
<?php
// Password update function with hashed password
