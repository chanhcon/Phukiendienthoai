...
<form id="cate-form" action="./index.php?act=addcate" method="POST" class="row g-3 form-cate"
    ...
    <div class="col-12">
        ...
        <p class="catename-error error-message"><?php if (isset($error['catename'])) {
                                                    echo $error['catename'];
                                                } ?></p>
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        ...
        <img src="..uploads/<?php if (isset($image)) {
                                echo $image;
                            } ?>" style="" class="w-100 cate-img"
            alt="<?php if (isset($image)) {
                        echo $image;
                    } ?>">
        <p><?php if (!isset($image)) {
                echo "Hình ảnh danh mục sản phẩm trống";
            } ?></p>
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        ...
        <p class="error-message catedesc-error"><?php if (isset($error['catedesc'])) {
                                                    echo $error['catedesc'];
                                                } ?></p>
    </div>
    <div class="col-12">
