...
--
-- Host: localhost:3306
-- Generation Time: Feb 11, 2025 at 04:02 AM
...
CREATE TABLE `tbl_blog` (
  ...
  `blog_title` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `noi_dung` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `images` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `create_time` datetime NOT NULL,
  `blogcate_id` int NOT NULL,
...
CREATE TABLE `tbl_blog_cate` (
  `id` int NOT NULL,
  `blog_catename` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `tbl_blog_comment` (
  ...
  `noi_dungbl` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `tbl_coupon` (
  ...
  `coupon_code` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(3, 'SALEOFF_10', 50.00, 4000000.00, 10, '2023-03-30 11:15:03', '2026-04-30 16:15:04'),
...
CREATE TABLE `tbl_danhgiasp` (
  ...
  `images_review` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(19, 11, 2, '', '', 3.0, '2025-02-10 10:12:45', 35, 1);
...
CREATE TABLE `tbl_danhmuc` (
  ...
  `ten_danhmuc` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `hinh_anh` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `tbl_danhmucphu` (
  `id` int NOT NULL,
  `iddm` int NOT NULL,
  `ten_danhmucphu` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `tbl_feedback` (
  ...
  `content` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `date_create` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `tbl_nguoidung` (
  ...
  `diachi` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `shipping_id` int NOT NULL DEFAULT '0',
  `sodienthoai` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `kich_hoat` tinyint(1) NOT NULL DEFAULT '1',
  `hinh_anh` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'avatar-user-default.jpg',
  `email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `vai_tro` tinyint(1) NOT NULL DEFAULT '3',
  `congty` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `default_payment` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'codpayment',
  `about_me` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
(52, '2aeef4fee73f1578abd0c3f83e682520', 'Dương Tùng Anh', NULL, 0, NULL, 1, 'avatar-user-default.jpg', 'anhdtpn00110@gmail.com', 3, NULL, 'codpayment', NULL);
...
CREATE TABLE `tbl_order` (
  `id` int NOT NULL,
  `madonhang` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `tongdonhang` double(10,0) NOT NULL,
  `shipping_fee` double(10,2) NOT NULL DEFAULT '0.00',
  `vat_fee` double(10,2) NOT NULL DEFAULT '0.00',
  `pttt` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `iduser` int NOT NULL,
  `name` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `dienThoai` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  ...
  `coupon_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `reason_destroy` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `tbl_order_detail` (
  ...
  `tensp` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `hinhanh` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `tbl_sanpham` (
  ...
  `tensp` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `don_gia` double(11,2) NOT NULL DEFAULT '0.00',
  `ton_kho` int NOT NULL DEFAULT '100',
  ...
  `ma_danhmuc` int NOT NULL,
  `id_dmphu` int NOT NULL,
  `information` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `tbl_shipping` (
  ...
  `detail_address` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `shipping_type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'GHN'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `tbl_vnpay` (
  ...
  `amount` int NOT NULL,
  `bankcode` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `banktransno` int NOT NULL,
  `cardtype` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `orderinfo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `paydate` datetime NOT NULL,
  `tmncode` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
--
ALTER TABLE `tbl_binhluan`
  MODIFY `ma_binhluan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_blog_comment`
  MODIFY `id_bl` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `tbl_coupon`
--
ALTER TABLE `tbl_coupon`
  MODIFY `id_coupon` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tbl_danhgiasp`
--
ALTER TABLE `tbl_danhgiasp`
  MODIFY `id_review` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `tbl_danhmuc`
--
ALTER TABLE `tbl_danhmuc`
  MODIFY `ma_danhmuc` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `tbl_reply_reviews`
  MODIFY `id_reply` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_sanpham`
--
ALTER TABLE `tbl_sanpham`
  MODIFY `masanpham` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `tbl_vnpay`
  MODIFY `id_vnpay` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
